...
const root = await fs.mkdtemp(path.join(os.tmpdir(), 'mcp-device-remote-yolo-'));
...
const target = path.join(wideDir, 'outside-configured-allowlist.txt');
...
process.env.MCP_DEVICE_CONFIG_DIR = configDir;
